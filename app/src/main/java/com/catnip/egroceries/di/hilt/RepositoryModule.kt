...
object RepositoryModule {
    @Singleton
    @Provides
    fun provideCartRepository(cartDataSource: CartDataSource, eGroceriesDataSource: EGroceriesDataSource): CartRepository {
        return CartRepositoryImpl(cartDataSource, eGroceriesDataSource)
    }

    @Singleton
    @Provides
    fun provideProductRepository(eGroceriesDataSource: EGroceriesDataSource): ProductRepository {
